<?php
	if(isset($_POST['search'])){
		...
		$sql="select * from sanpham, mathang, nhanhieu where sanpham.tensp LIKE '%$search%' and mathang.id_mathang=sanpham.id_mathang and nhanhieu.id_nhanhieu=sanpham.id_nhanhieu order by sanpham.id_sp asc";
		$run=$conn->query($sql);
		$count=$run->num_rows;
		if($count>0){
?>
